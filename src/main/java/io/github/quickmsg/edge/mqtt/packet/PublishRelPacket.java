...
public class PublishRelPacket implements Packet {
    ...
    public PublishRelPacket(Endpoint<Packet> endpoint, int messageId, byte reason, long timestamp, boolean dup, boolean retry, AckPair ackPair) {
